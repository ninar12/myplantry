    ...
    >
      ...
      <header className="flex items-center justify-between px-6 pt-8 pb-4">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-base" style={{ fontFamily: "var(--font-plus-jakarta), sans-serif", color: "#003527" }}>
            Plantry
          </span>
        </Link>
        <Link
      ...
      <main className="flex-1 flex flex-col justify-center px-6 py-8 max-w-md mx-auto w-full">
        <div className="mb-8">
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#404944" }}>
            Return to your curated larder and discover what&apos;s fresh today.
          </p>
        </div>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl font-semibold text-white text-sm flex items-center justify-center gap-3 transition-all hover:opacity-90 active:scale-[0.98]"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-6">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-medium" style={{ color: "#2b6954", cursor: "pointer" }}>
                  Forgot password?
                </span>
              </div>
        ...
        <p className="text-center text-sm mt-8" style={{ color: "#707974" }}>
          ...
          <Link href="/auth/signup" className="font-semibold" style={{ color: "#003527" }}>
            Sign Up
          </Link>
        </p>
      </main>
